...
export interface UserProfileHeaderResponse extends BaseResponse {
  dsProfileHeaderInfo: UserProfileHeaderInfoEntry[];
}
...
export interface UserProfileHeaderInfoEntry {
  EXP: number;
  EXP_TIER_CATEGORY_ID: number;
  EXP_TIER_DISPLAY_NAME: string;
  EXP_TIER_SCORE_END: number;
  EXP_TIER_SCORE_INI: number;
  EXP_TIER_SCORE_INI_NEXT: number;
  FAME_GRADE: number;
  LEV: number;
  NICK: string;
  REG_DATE: number;
